                ...
                <div className="relative backdrop-blur-sm bg-[#0D121C]/80 p-8 sm:p-10 rounded-2xl shadow-2xl border border-gray-800/50">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                    <svg className="w-5 h-5 text-gray-400 peer-focus:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                        ...
                        <div
                            ...
                            className={`relative cursor-pointer p-4 rounded-xl border backdrop-blur-sm transition-all duration-300 ${notificationsEnabled
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className={`p-2.5 rounded-lg transition-all duration-300 ${notificationsEnabled ? 'bg-green-500/20' : 'bg-gray-700/50'
                                        }`}>
                                        <svg
                                    ...
                                    <div>
                                        <p className={`text-sm sm:text-base font-medium transition-colors duration-300 ${notificationsEnabled ? 'text-green-400' : 'text-gray-300'
                                            }`}>
                                            Push Notifications
                                        </p>
                                        <p className="text-xs text-gray-500 mt-0.5">
                                            {notificationsEnabled ? 'Enabled - Click to disable' : 'Click to enable notifications'}
                                        </p>
                                    </div>
                                </div>

                                <div className={`relative w-12 h-6 rounded-full transition-all duration-300 ${notificationsEnabled ? 'bg-green-500' : 'bg-gray-600'
                                    }`}>
                                    <div className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-md transform transition-transform duration-300 flex items-center justify-center ${notificationsEnabled ? 'translate-x-6' : 'translate-x-0'
                                        }`}>
