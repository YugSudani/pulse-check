            ...
            >
                ...
                <div>
                    <div className="flex items-center gap-2 text-xl sm:text-2xl font-semibold mb-10">
                     ...
                     <button
                className="md:hidden fixed top-6 right-5 z-50 bg-[linear-gradient(0deg,_rgba(59,215,113,0.2)_0%,_rgb(20,32,45)_75%)] px-3 py-2 rounded-md h-8 w-12 flex items-center justify-center hover:bg-[#393a3b] transition"
                onClick={() => setOpenSidebar(!openSidebar)}
            >
                ✕ 
            </button>
                    ...
                    <nav className="space-y-2 sm:space-y-3 text-gray-300">
                        <button
                            onClick={() => { navigate("/dashboard", { replace: true }); setOpenSidebar(false); }}
                            className="flex items-center gap-3 p-3 sm:p-3 hover:bg-[#121A28] rounded-lg transition w-full text-left min-h-[44px]"
                        >
                            <span className="text-green-500">🟢</span> Monitoring
                        </button>

                        <button
                            onClick={() => { navigate("/incidents", { replace: true }); setOpenSidebar(false); }}
                            className="flex items-center gap-3 p-3 sm:p-3 hover:bg-[#121A28] rounded-lg transition w-full text-left min-h-[44px]"
                        >
                            🛡️ Incidents
                        </button>
                        ...
                        <button
                            onClick={() => { navigate("/status-pages", { replace: true }); setOpenSidebar(false); }}
                            className="flex items-center gap-3 p-3 sm:p-3 hover:bg-[#121A28] rounded-lg transition w-full text-left min-h-[44px]"
                        >
                            📡 Status pages
                        </button>
                        ...
                        <button
                            onClick={() => { navigate("/maintenance", { replace: true }); setOpenSidebar(false); }}
                            className="flex items-center gap-3 p-3 sm:p-3 hover:bg-[#121A28] rounded-lg transition w-full text-left min-h-[44px]"
                        >
                            🛠️ Maintenance
                        </button>
                        ...
                        <button
                            onClick={() => { navigate("/team", { replace: true }); setOpenSidebar(false); }}
                            className="flex items-center gap-3 p-3 sm:p-3 hover:bg-[#121A28] rounded-lg transition w-full text-left min-h-[44px]"
                        >
                            👤 Team members
                        </button>
                        ...
                        <button
                            onClick={() => { navigate("/integrations", { replace: true }); setOpenSidebar(false); }}
                            className="flex items-center gap-3 p-3 sm:p-3 hover:bg-[#121A28] rounded-lg transition w-full text-left min-h-[44px]"
                        >
                            🔗 Integrations & API
                        </button>
