...
export default function CreateNewMonitor() {
    ...
    const CreateMonitor = async () => {
        try {
            const response = await axios.post(
                `${import.meta.env.VITE_API_URL}/monitor/createMonitor`,
                {
                    name,
                    url,
                    interval
    ...
    return (
        <div className="overflow-y-auto h-[100vh] flex-1 p-3  md:p-10">
            ...
            <Link
                to="/dashboard"
                className="mt-14 ml-1 md:ml-0 md:mt-0 inline-block bg-[#121A28] px-4 py-2 rounded-lg mb-6 hover:bg-[#172235] cursor-pointer font-bold text-lg "
            >
                ← Monitoring
            </Link>
            ...
            <div className="bg-[#0D121C] border border-gray-800 rounded-xl p-6 md:p-10 space-y-10">

                {/* ================= MONITOR TYPE ================= */}
                <section>
                    <h2 className="text-xl font-semibold mb-3">Monitor type</h2>

                    <div className="bg-[#121A28] border border-gray-700 p-4 rounded-lg flex justify-between items-center">
                        <div>
                            <p className="font-semibold">HTTP / website monitoring</p>
                ...
                {/* ================= URL INPUT ================= */}
                <section>
                    <h2 className="text-xl font-semibold mb-3">URL to monitor</h2>

                    <input
                        type="text"
                        value={url}
                        onChange={(e) => setUrl(e.target.value)}
                        className="w-full px-4 py-3 bg-[#121A28] border border-gray-700 rounded-lg outline-none text-gray-200"
                    />
                </section>
                ...
                <section className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                            ...
                            <span className="text-green-500 cursor-pointer">Upgrade now</span>
                        </div>

                        <select className="w-full px-4 py-3 bg-[#121A28] border border-gray-800 rounded-lg text-gray-400">
                    ...
                    {/* Tags */}
                    <div>
                        <h2 className="text-xl font-semibold mb-3">Give Name to your monitor</h2>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-[#121A28] border border-gray-700 rounded-lg text-gray-200 outline-none"
                        />
                    </div>
                ...
                {/* ================= NOTIFICATIONS ================= */}
                <section>
                    <h2 className="text-xl font-semibold mb-4">How will we notify you?</h2>
                ...
                {/* ================= MONITOR INTERVAL ================= */}
                <section>
                    <h2 className="text-xl font-semibold mb-3">Monitor interval</h2>
                ...
                <section>
                    ...
                    <select className="w-full bg-[#121A28] px-4 py-3 rounded-lg border border-gray-800 text-gray-300">
                        <option>Default (auto-select by UptimeRobot)</option>
                    </select>
                </section>
