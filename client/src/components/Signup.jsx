                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`peer w-full pl-12 pr-4 py-3.5 bg-[#121A28]/60 backdrop-blur-sm border rounded-xl text-gray-200 placeholder-gray-500 outline-none focus:bg-[#121A28] transition-all text-sm sm:text-base min-h-[48px]
                                        ${errors.name ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-gray-700/50 focus:border-green-500 focus:ring-2 focus:ring-green-500/20"}`}
                                />
                            </div>
                            {errors.name && (
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className={`peer w-full pl-12 pr-4 py-3.5 bg-[#121A28]/60 backdrop-blur-sm border rounded-xl text-gray-200 placeholder-gray-500 outline-none focus:bg-[#121A28] transition-all text-sm sm:text-base min-h-[48px]
                                        ${errors.email ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-gray-700/50 focus:border-green-500 focus:ring-2 focus:ring-green-500/20"}`}
                                />
                            </div>
                            {errors.email && (
                                <p className="text-red-400 text-sm mt-1.5 flex items-center gap-1">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className={`peer w-full pl-12 pr-4 py-3.5 bg-[#121A28]/60 backdrop-blur-sm border rounded-xl text-gray-200 placeholder-gray-500 outline-none focus:bg-[#121A28] transition-all text-sm sm:text-base min-h-[48px]
                                        ${errors.pwd ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-gray-700/50 focus:border-green-500 focus:ring-2 focus:ring-green-500/20"}`}
                                />
                            </div>
                            {errors.pwd && (
                                <p className="text-red-400 text-sm mt-1.5 flex items-center gap-1">
